    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('starred_by', models.ManyToManyField(related_name='starred_questions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('starred_by', models.ManyToManyField(related_name='starred_answers', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
